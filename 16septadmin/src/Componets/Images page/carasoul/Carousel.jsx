...
const SimpleCarousel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://192.34.63.158:4000/slider/add`, formData, {
        headers: {
  ...
  const removeImage = async (id) => {
    const { data } = await axios.post(`http://192.34.63.158:4000/slider/delete`, { id: id },
    )

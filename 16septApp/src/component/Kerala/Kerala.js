...
const Kerala = () => {
  return (
    <>
      ...
      <Link to="/commentAndhra/Kerala/Hill Stations in Kerala">
      <div className={Styles.ad}>
      <div>
      ...
      <br />
      <br />
      <Link to="/commentAndhra/Kerala/Best of South India with Kerala">
      <div className={Styles.ad}>
        <div>
      ...
      <br />
      <br />
      <Link to="/commentAndhra/Kerala/Escape to Kerala">
      <div className={Styles.ad}>
      <div>
      ...
      <br />
      <br />
      <Link to="/commentAndhra/Kerala/Enchanting Kerala">
      <div className={Styles.ad}>
        <div>
      ...
      <br />
      <br />
      <Link to="/commentAndhra/Kerala/Kerala Honeymoon Tour">
      <div className={Styles.ad}>
      <div>
      ...
      <Link to="/commentAndhra/Kerala/Kerala Spices & Plantation Tour">
      <div className={Styles.ad}>
        <div>

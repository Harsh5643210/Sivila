...
const Bihar = () => {
 ...
 <Homescara />
      ...
      <br />
      {isVisible && 
       <Link to="/commentAndhra/Bihar/Nalanda University">
      ...
      <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Bihar/Bhodhi Tree">
        <div className={Styles.ad}>
        <div>
        ...
        <Link to="/commentAndhra/Bihar/Griddhakuta Peak">
        <div className={Styles.ad}>
          <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Bihar/Hieun Tsang Memorial Hall">
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Bihar/Jalmandir Temple">
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Bihar/Patna Museum">
        <div className={Styles.ad}>
          <div>

...
import PageRenderAd from '../PageRenderAd/pageRenderAd.js'
import { Link } from 'react-router-dom';

import ImageCarousel from '../locationCarousel/ImageCarousel.jsx'
...
import Andhracara from '../public carasoul/homesCara/Home';
    ...
    <>
      <div className={Styles.container}>
        <div className={Styles.main}>
          <div className={Styles.text}><h1  >Welcome to Andhra Pradesh</h1></div>
...
<div  className={Styles.ad}> 
          ...
          <Link to="/commentAndhra/Andhra/Tirupati Tourism">
          <div>
            ...
            <div className={Styles.textt}>
              ...
              <div ><img style={{width:'100%',marginTop:'10px' ,height:'100px' }} src='http://192.34.63.158:4000/add/add1693835985155_WhatsApp%20Image%202023-09-04%20at%207.25.29%20PM.jpeg'/></div>
        ...
        <br />
        <br />
        <Link to={`/commentAndhra/Amaravathi Tourism`}>
        <div className={Styles.ad}>
          <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Vijayawada Tourism">
        <div className={Styles.ad}>
          <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/The Heritage Haven of Andhra">
        <div className={Styles.ad}>
          <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Srisailam Tourism">
        <div className={Styles.ad}>
          <div>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Lepakshi Tourism">
        <div className={Styles.ad}>
          <div>
            Lepakshi Tourism
            <div className={Styles.textt}>
        ...
        <br />
        <br />
        <Link to="/commentAndhra/Chittoor Tourism">
        <div className={Styles.ad}>
          <div>

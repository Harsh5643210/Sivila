...
<div ><img style={{width:'100%' }} src='http://192.34.63.158:4000/add/add1693835985155_WhatsApp%20Image%202023-09-04%20at%207.25.29%20PM.jpeg'/></div>
 <br/>
    <div>
        ...
        <Link to="/commentAndhra/Madhya-Pradesh/Omkareshwar Temple">
...
<Link to="/commentAndhra/Madhya-Pradesh/Bharat Bhavan">
        <div className='mpcatogaryDiv'>
...
<Link to="/commentAndhra/Madhya-Pradesh/Patalpani Waterfall">
        <div className='mpcatogaryDiv'>
...
<Link to="/commentAndhra/Madhya-Pradesh/Mansingh Palace">
        <div className='mpcatogaryDiv'>
...
<Link to="/commentAndhra/Madhya-Pradesh/Kanha National Park">
        <div className='mpcatogaryDiv'>
